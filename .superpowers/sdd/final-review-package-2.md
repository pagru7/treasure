...
Head: e957f2f9857b79c7888d1fabc16d1286cfb183ec

## Commits

e957f2f Fix account sharing review findings
...
## Diff Stat
 ...
 .gitignore                                         |   3 +
 .../Application/Accounts/AccountSharingService.cs  | 113 ++++++++
 .../Accounts/ShareAccountReadOnlyEndpoint.cs       |  65 ++---
 src/Treasury.App/Pages/Accounts.razor              | 135 ++++-----
 src/Treasury.App/Pages/Accounts.razor.cs           | 224 +++++++++++++++
 src/Treasury.App/Program.cs                        |   2 +
 .../AccountsSharingUiTests.cs                      | 303 +++++++++++++++++++++
 .../SharedReadOnlyUiPermissionTests.cs             |  50 ++++
 8 files changed, 772 insertions(+), 123 deletions(-)
...
@@ -59,20 +99,30 @@ public class SharedReadOnlyUiPermissionTests
             AccountId = accountId,
